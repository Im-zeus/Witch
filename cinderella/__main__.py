...
SOURCE_STRING = """
[🧚‍♀️SOURCE CODE🧚‍♀️](https://t.me/neepodamonkey)
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🧚‍♀️𝘏𝘌𝘓𝘗🧚‍♀️",callback_data="help_back"),InlineKeyboardButton(text="🧚‍♀️𝘊𝘙𝘌𝘈𝘛𝘖𝘙🧚‍♀️",url="https://t.me/darkholdz")]]
    keyboard += [[InlineKeyboardButton(text="🧚‍♀️𝘊𝘖𝘕𝘕𝘌𝘊𝘛 𝘎𝘙𝘖𝘜𝘗🧚‍♀️", callback_data="main_connect"),InlineKeyboardButton(text="🧚‍♀️𝘈𝘋𝘋 𝘔𝘌🧚‍♀️",url="t.me/{}?startgroup=true".format(bot.username))]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="🧚‍♀️Help🧚‍♀️",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🧚‍♀️Contact Creator🧚‍♀️",url="https://t.me/itzmezeus")]]))
        return
