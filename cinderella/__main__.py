...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🧚‍♀️𝘏𝘌𝘓𝘗🧚‍♀️",callback_data="help_back"),InlineKeyboardButton(text="🧚‍♀️𝘖𝘞𝘕𝘌𝘙🧚‍♀️",url="https://t.me/darkholdz")]]
    keyboard += [[InlineKeyboardButton(text="🧚‍♀️𝘊𝘖𝘕𝘕𝘌𝘊𝘛🧚‍♀️", callback_data="main_connect"),InlineKeyboardButton(text="🧚‍♀️𝘈𝘋𝘋 𝘔𝘌🧚‍♀️",url="t.me/{}?startgroup=true".format(bot.username))]]
